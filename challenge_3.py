...
regex1 = r"[a-z]{1}[A-Z]{3}[a-z]{1}[A-Z]{3}[a-z]{1}"
regex2 = r"[A-Z]{1}[a-z]{1}[A-Z]{1}"
regex3 = r"[a-z]{1}"

matches = re.findall(regex1, text_given)

matches = " ".join(matches)

filter_results = re.findall(regex2, matches)

filter_results = " ".join(filter_results)

result = re.findall(regex3, filter_results)
